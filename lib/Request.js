/*
 * This is a copy of some other library directly from github:
 * Link: https://github.com/dragonfire535/node-superfetch
...
class Request {
	...
	constructor(url, method, options) {
		if (!url) throw new Error('You must provide the URL.');
		this.url = url;
